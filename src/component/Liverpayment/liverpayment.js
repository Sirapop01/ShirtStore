...
const Liverpayment = () => {
  ...
  const applyDiscount = () => {
    if (product !== null) {
      ...
      return 0; // หรือค่าเริ่มต้นอื่นๆ ที่คุณต้องการ
    }
  };
        ...
        <div className="Block-Payment">
          ...
          <div className="Block-Shirt">
            ...
            <div className="Teamshirt">
              ...
              <h2 className="football-Namemanu">LIVERPOLL FOOTBALL CLUB SHIRT</h2>
